...
public class VersionUtils {
  ...
  public static boolean isValidUpgrade(String currentVersion, String targetVersion) {
    boolean isCompatibleMajorVersionChange = (currentVersion.equals("7.17.28") && targetVersion.equals("8.0.0")) || (currentVersion.equals("8.19.0") && targetVersion.equals("9.0.0"));
