...
class ElasticSupportMatrixCheckTest {
  @Mock
  ...
  @InjectMocks
  private ElasticSupportMatrixCheck precheck;
  ...
  @ParameterizedTest
  @MethodSource("should_pass_check_data_fail")
  ...
  static Stream<Arguments> should_pass_check_data_fail() {
    return Stream.of(
